...
void write_fout(std::ofstream &fout, short arr[MAX_PLAYER][MAX_SHAPE][AREA], const char *arr_name)
{
...
int main()
{
    std::ofstream fout("precalc_worths.txt");
    init_black_worths();
    write_fout(fout, WORTH_OPENING, VAR_NAME(WORTH_OPENING));
    write_fout(fout, WORTH_ENDGAME, VAR_NAME(WORTH_ENDGAME));
    fout.close();
}